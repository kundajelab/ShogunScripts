...
from modshogun import PROTEIN, Labels
...
def runShogunSVMProteinSpectrumKernel(train_xt, train_lt, test_xt):
	"""
	...
	feats_train = StringUlongFeatures(PROTEIN)
	...
	feats_test=StringUlongFeatures(PROTEIN)
...
if __name__=='__main__':
	...
	[out1, out2, out1DecisionValues, out2DecisionValues] = runShogunSVMProteinSpectrumKernel(train_xt, train_lt, test_xt)
