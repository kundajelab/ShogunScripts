...
WIDTH = float(sys.argv[9]) # Initially 1
...
def runShogunSVMDNAOligoStringKernel(train_xt, train_lt, test_xt):
	"""
	...
	kernel=OligoStringKernel(10, K, WIDTH)
...
if __name__=='__main__':
	...
	[out1, out2, out1DecisionValues, out2DecisionValues] = runShogunSVMDNAOligoStringKernel(train_xt, train_lt, test_xt)
